  ...
  const products = [
    {
      ...
      description: "Rastreamento inteligente de portfólios cripto. Cadastre seus ativos cripto, acompanhe sua evolução e invista automaticamente com um Robô de Investimento!",
